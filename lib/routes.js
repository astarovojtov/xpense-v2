...
FlowRouter.route('/analytics', {
  ...
  action() {
    GAnalytics.pageview();
    BlazeLayout.render('MainLayout', {main: 'AnalyticsLayout'});
  }
...
FlowRouter.route('/chart', {
  ...
  action() {
    GAnalytics.pageview();
    BlazeLayout.render('Chart', {main: 'Card'});
  }

});

FlowRouter.route('/advisor', {
  name: 'advisor',
  action() {
    BlazeLayout.render('MainLayout', {main: 'Advisor'});
  }
});